...
function renderSocialMedia() {
  ...
  rights.textContent = 'rights.textContent = '© All copyrights belong to Exito Media Concepts and the respective clients of each post. These are client-approved designs, some shown here are my own variations of the same.';';
